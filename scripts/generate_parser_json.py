...
def main():
    ...
    rules = [
        ...
        Rule(
            "assignExpr",
            ["LET", "IDENTIFIER", "EQUAL", "opCoalesceExpr", "PIPE", "assignExpr"],
        ),
        Rule(
            "assignExpr",
            [
        ...
        Rule("opPipeExpr", ["opCoalesceExpr"]),
        Rule("opPipeExpr", ["opPipeExpr", "PIPE", "opCoalesceExpr"]),
        Rule("opCoalesceExpr", ["opOrExpr"]),
        Rule("opCoalesceExpr", ["opCoalesceExpr", "DOUBLE_QUESTION", "opOrExpr"]),
        ...
        Rule("opMulExpr", ["opAccessExpr"]),
        Rule("opMulExpr", ["opMulExpr", "opMulOperator", "opAccessExpr"]),
        Rule("opAccessExpr", ["baseExpr"]),
        Rule("opAccessExpr", ["opAccessExpr", "DOT", "IDENTIFIER"]),
        Rule(
            "opAccessExpr",
            ["opAccessExpr", "LEFT_BRACKET", "listAccessExpr", "RIGHT_BRACKET"],
        ),
